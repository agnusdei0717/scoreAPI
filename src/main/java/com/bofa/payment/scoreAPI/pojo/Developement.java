...
public class Developement {
    ...
    public Developement(Integer id){
        this.id = id;
    }

    public Developement(String name, Date receiveDate, Integer status, Integer agent, String situation, Date endDate, String uatResult, String prdResult, String remark, String year, String month, Integer type) {
        this.name = name;
    ...
    public Developement(Integer id, String name, Date receiveDate, Integer status, Integer agent, String situation, Date endDate, String uatResult, String prdResult, String remark, String year, String month, Integer type) {
        this.id = id;
        this.name = name;
        this.receiveDate = receiveDate;
        this.status = status;
